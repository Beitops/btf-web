			...
			<div className="rounded-3xl border border-gray-100 bg-white p-4 shadow-sm md:p-6">
				...
				>
					<div className="space-y-3">
						...
						<div>
							<label className="mb-1 block text-sm font-medium text-gray-700" htmlFor="iban">
								IBAN
							</label>
							<input
								id="iban"
						...
						{data.direccionFacturacionDiferente && (
							<div className="space-y-3 rounded-2xl border border-gray-100 bg-gray-50/60 p-3 md:p-4">
								...
								<div className="grid grid-cols-1 gap-3 md:grid-cols-2">
									<div>
										<label className="mb-1 block text-sm font-medium text-gray-700" htmlFor="facturacionCalle">
											Calle
										</label>
										<input
											id="facturacionCalle"
									...
									<div>
										<label className="mb-1 block text-sm font-medium text-gray-700" htmlFor="facturacionNumero">
											Número
										</label>
										<input
								...
								<div className="grid grid-cols-1 gap-3 md:grid-cols-2">
									<div>
										<label className="mb-1 block text-sm font-medium text-gray-700" htmlFor="facturacionPiso">
											Piso
										</label>
										<input
											id="facturacionPiso"
									...
									<div>
										<label className="mb-1 block text-sm font-medium text-gray-700" htmlFor="facturacionLetra">
											Letra
										</label>
										<input
											id="facturacionLetra"
								...
								<div className="grid grid-cols-1 gap-3 md:grid-cols-2">
									...
									<div>
										<label className="mb-1 block text-sm font-medium text-gray-700" htmlFor="facturacionCiudad">
											Ciudad
										</label>
										<input
